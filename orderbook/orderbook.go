...
// the Limit of the Order is basically a reference to the Limit
// so if the Order is to be decoupled from our Limit we can still
...
// Bids: If you want to buy
// Asks: If you want to sell
...
func (ob *Orderbook) PlaceMarketOrder(o *Order) []Match {
	...
	if o.Bid {
		if o.Size > ob.AskTotalVolume() {
			panic(fmt.Errorf("not enough volume [size: %.2f] for market order [size: %2.f]",
				ob.AskTotalVolume(),
				o.Size))
		}
